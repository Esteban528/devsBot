...
module.exports = {
	...
	async execute(interaction) {
		...
		const embed = new EmbedBuilder()
			...
			.addFields(
				{
					name: `<:_:1243296521009758208>  Server ID:`,
					value: `└ ${serwer.id}`,
					inline: true,
				},
				{
					name: `<:_:1243296498125635584> Fecha de Creación:`,
					value: `└ <t:${Math.floor(serwer.createdTimestamp / 1000)}:R>`,
					inline: true,
				},
				{
					name: `<:_:1243296514600865832> Dueños:`,
					value: `└ ${owner?.user?.toString() || "dueño"}\n└ ${mention}`,
					inline: true,
				},
				{
					name: `<:_:1243296475958738974> Miembros (${serwer.memberCount})`,
					value: `└ **${onlineMembers.size}** Online ✅\n└ **${BoosterCount}** Boosters 💜`,
					inline: true,
				},
				{
					name: `<:_:1243296390902321173> Canales (${totalChannels})`,
				...
				{
					name: `<:_:1243296460917833808> Otros:`,
					value: `└ Verificación nivel: **${verificationLevel}**`,
					inline: true,
				},
				{
					name: `<:_:1243296544351060118> Roles (${allRolesCount})`,
